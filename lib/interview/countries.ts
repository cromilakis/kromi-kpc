/**
 * Lista de países (nombre en español) para el selector de destino de
 * transferencias internacionales del RAT. Curada y ordenada alfabéticamente;
 * cubre destinos habituales de transferencias desde Chile y el resto del mundo.
 * Se guarda el nombre en español como valor (coherente con el resto del RAT,
 * que usa texto libre); ampliable sin migración.
 */
export const COUNTRIES: readonly string[] = [
  ...
  "Honduras", "Hong Kong", "Hungría", "India", "Indonesia", "Irak", "Irán",
